...
def main():
    if os.path.exists("./training_data_new/data_verts.npy"):
        ...
        print(len(data2array["3.mp4"]) / 1800)
        print(len(data2array["4.mp4"]) / 1800)
        print(len(data2array["5.mp4"]) / 1800)
        print(len(data2array["6.mp4"]) / 1800)
        print(len(data2array["7.mp4"]) / 1800)
